...
const AdminCategoryList = () => {
  ...
  const columns = [
    ...
    { title: '操作', key: 'action', width: 200, render: (_: any, record: Category) => (
      <Space>
        <Button type='link' icon={<EditOutlined />} onClick={() => navigate('/admin/categories/' + record.id + '/edit')}>编辑</Button>
  ...
  return (
    <div>
      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: 16 }}>
        ...
        <Space>
          <Button type='primary' icon={<PlusOutlined />} onClick={() => navigate('/admin/categories/new')}>新增</Button>
        </Space>
      </div>
