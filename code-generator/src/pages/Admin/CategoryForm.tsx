...
const AdminCategoryForm = () => {
  ...
  return (
    <div>
      <Button icon={<ArrowLeftOutlined />} onClick={() => navigate('/admin/categories')} style={{ marginBottom: 16 }}>返回</Button>
      <Card>
        ...
        { name: 'updatedTime', label: '更新时间', component: 'input', required: false }].map(item => (
          ...
          <Form.Item>
            ...
            <Button style={{ marginLeft: 8 }} onClick={() => navigate('/admin/categories')}>取消</Button>
          </Form.Item>
        </Form>
      </Card>
    </div>
