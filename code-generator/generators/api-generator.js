...
class ApiGenerator {
  static async generate(module, project, projectRoot) {
    const apiDir = path.join(projectRoot, project.basePath, module.apiPath);
...
import { ${moduleName}, ${moduleName}QueryParams, PageResponse } from '@/types';
...
export const get${pluralName} = (params?: ${moduleName}QueryParams) => {
