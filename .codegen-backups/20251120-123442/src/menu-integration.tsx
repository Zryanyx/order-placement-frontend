  ...
  products: [
    {
      ...
      role: 'ADMIN',
      children: [
        { key: '/admin/category', label: '商品分类列表', role: 'ADMIN', onClick: () => navigate('/admin/category') }
      ]
    }
  ],
  ...
  user: [
    {
      ...
      role: 'ADMIN',
      children: [
        { key: '/admin/user-addresses', label: '用户地址列表', role: 'ADMIN', onClick: () => navigate('/admin/user-addresses') }
      ]
    }
  ]
}
