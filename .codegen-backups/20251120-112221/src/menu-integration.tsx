  ...
  products: [
    {
      ...
      role: 'ADMIN',
      children: [
        { key: '/admin/categories', label: '商品分类列表', role: 'ADMIN', onClick: () => window.location.href = '/admin/categories' }
      ]
    }
  ],
  ...
  user: [
    {
      ...
      role: 'ADMIN',
      children: [
        { key: '/admin/user-addresses', label: '用户地址列表', role: 'ADMIN', onClick: () => window.location.href = '/admin/user-addresses' }
      ]
    }
  ]
}
